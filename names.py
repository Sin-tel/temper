...
('enneadecal','[-14 -19 19]'),# 6+1/3; 1\19 = 28/27
# ideal number of 81/80's is about here
...
('chlorine','[-52 -17 34]'),# 1\17 = 25/24
('vishnu','[23 6 -14]'),# (4/3)/(25/24)^7

# 2.5 subgroup:
('bug','27/25'),
('augmented','128/125'), # 1\3
('birds','[72 0 -31]'), # 10\31

# 2.7 subgroup:
('cloudy','[-14 0 0 5]'), # 4\5
('birds','[-87 0 0 31]'), # 25\31
...
('slendrismic','[36 -5 0 -10]'),# 3.33... = 10/3; epic temp making 147/128 = 1\5; near-just (~3.3)
...
('enneadecal','[-37 57 0 -19]'), # 1\19 = 28/27
